...
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <button class="btn" style="background: #9C27B0; color: white; border: none;" data-bs-toggle="modal" data-bs-target="#nuevoCentroModal">
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge" style="background: #9C27B0; color: white;">
                                        <?php echo $pacientesCount; ?> pacientes
                                    </span>
                                </td>
                                <td>
                                    ...
                                    <button class="btn btn-sm ms-2" style="background: #28a745; color: white; border: none;" onclick="gestionarProyectos(<?php echo $centro['id']; ?>, '<?php echo htmlspecialchars($centro['nombre']); ?>')" title="Gestionar Proyectos">
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-sm" style="background: #9C27B0; color: white; border: none;" onclick="editarCentro(<?php echo $centro['id']; ?>)">
        ...
        <div class="modal-content">
            ...
            <form id="formCentro" method="POST" action="guardar_centro.php">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn" style="background: #9C27B0; color: white; border: none;">Guardar Centro</button>
                </div>
            </form>
        </div>
    </div>
...
function gestionarProyectos(centroId, centroNombre) {
    window.location.href = 'proyectos_centro.php?centro_id=' + centroId + '&centro_nombre=' + encodeURIComponent(centroNombre);
}
</script>
